...
<%@ Page Language="C#" 
    ...
    Inherits="WingtipApprovalWorkflows.ProductApproval.WorkflowInitiationForm" 
...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
 ...
 <table border="0" cellspacing="0" cellpadding="0" class="ms-propertysheet">
    ...
    <wssuc:InputFormSection ID="InputFormSection3" runat="server" Title="Instructions to approver">
			<Template_Description>Feel free to pass along any additional instructions or information to the approver.</Template_Description>
			<Template_InputFormControls>
				<tr valign="top">
					<td class="ms-authoringcontrols" width="10">&#160;</td>
					<td class="ms-authoringcontrols" colspan="2">
	...
	<wssuc:ButtonSection runat="server" ID="btnsSaveCancel" ShowStandardCancelButton="false" ShowSectionLine="false"  >
		<Template_Buttons>
			<asp:PlaceHolder ID="PlaceHolder1" runat="server">
				<asp:Button ID="AssociateWorkflow" runat="server" OnClick="StartWorkflow_Click" Text="Start Workflow" CssClass="ms-ButtonHeightWidth" />
			</asp:PlaceHolder>
...
<asp:Content ID="PageTitle" ContentPlaceHolderID="PlaceHolderPageTitle" runat="server">
    Product Approval Initiation Form
</asp:Content>
