Write-Host "Executing Powershell script InstallSolution.ps1"
...
Write-Host "Solution Package has been installed"
$solution | where-object {$_.Name -eq $SolutionPackageName} | Format-List Name, DisplayName, SolutionId, Deployed, Status, ContainsGlobalAssembly, DeploymentState, DeployedServers